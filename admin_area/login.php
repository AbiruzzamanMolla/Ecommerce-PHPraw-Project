...
<head>
    ...
    <script src="https://codepen.io/dsenneff/pen/2c3e5bc86b372d5424b00edaf4990173.js"></script>
    <script src="https://cdnjs.cloudflare.com/ajax/libs/gsap/1.20.3/TweenMax.min.js"></script>
    <link href="https://fonts.googleapis.com/css?family=Source+Sans+Pro:400,600,700" rel="stylesheet">
    <link rel="stylesheet" href="https://codepen.io/dsenneff/pen/2c3e5bc86b372d5424b00edaf4990173.css">
    <link rel="stylesheet/scss" type="text/css" href="https://codepen.io/dsenneff/pen/2c3e5bc86b372d5424b00edaf4990173.scss">
    <style>
    /* colors */
$darkBlue: #217093;
$medBlue: #4eb8dd;
...
<body>
	...
	<div class="inputGroup inputGroup1">
		...
		<input type="email" id="loginEmail" maxlength="254" name="admin_email" placeholder="exampol@email.com" required/>
		<!-- <p class="helper helper1">email@domain.com</p> -->
	</div>
	<div class="inputGroup inputGroup2">
		<label for="loginPassword" id="loginPasswordLabel">Password</label>
		<input type="password" id="loginPassword" name="admin_pass" placeholder="Alphanumaric" required />
