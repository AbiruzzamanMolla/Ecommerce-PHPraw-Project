            ...
            <div class="container">
                ...
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand home" href="index.php">
                        ...
                        <img src="images/title.png" alt="computerfever logo" class="hidden-xs">
                        <img src="images/title1.png" alt="computerfever logo" class="visible-xs">
                    </a>
                ...
                <div class="col-md-9">
                    ...
                    <div class="box">
                        ...
                        if (isset($_POST['confirm_payment'])) {
                            ...
                            $update_pending_order = "update panding_orders set order_status='$complete' where order_id='$update_id'";
